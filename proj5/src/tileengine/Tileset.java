...
public class Tileset {
    ...
    public static final TETile ZOMBIE = new TETile('☣', Color.MAGENTA, Color.black, "zombie", 13);
    public static final TETile GOLD = new TETile('㊎', Color.yellow, Color.black, "gold", 14);
    public static final TETile WOOD = new TETile('㊍', Color.green, Color.black, "wood", 15);
    public static final TETile WATER = new TETile('㊌', Color.cyan, Color.black, "water", 16);
    public static final TETile FIRE = new TETile('㊋', Color.red, Color.black, "fire", 17);
    public static final TETile SOIL = new TETile('㊏', Color.orange, Color.black, "soil", 18);
    public static final TETile G_AVATAR = new TETile('❂', Color.yellow, Color.black, "g_avatar", 19);
    public static final TETile F_AVATAR = new TETile('❂', Color.red, Color.black, "f_avatar", 19);
}
